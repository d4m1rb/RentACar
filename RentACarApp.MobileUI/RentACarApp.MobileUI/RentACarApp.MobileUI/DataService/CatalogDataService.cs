...
namespace RentACarApp.MobileUI.DataService
{
    /// <summary>
    ...
    public class CatalogDataService
    {
        ...
        private ListaVozilaViewModel listaVozilaViewModel;
        ...
        /// </summary>
        public ListaVozilaViewModel ListaVozilaViewModel =>
            this.listaVozilaViewModel ??
            (this.listaVozilaViewModel = PopulateData<ListaVozilaViewModel>("ecommerce.json"));
        ...
        {
            var file = "RentACarApp.MobileUI.Data." + fileName;
