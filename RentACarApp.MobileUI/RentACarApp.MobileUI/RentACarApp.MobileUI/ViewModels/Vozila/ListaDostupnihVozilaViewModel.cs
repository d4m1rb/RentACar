...
namespace RentACarApp.MobileUI.ViewModels.Vozila
{
    ...
    [DataContract]
    public class ListaDostupnihVozilaViewModel : BaseViewModel
    {
        ...
        public List<AutomobilVM> VozilaList { get; set; } = new List<AutomobilVM>();
        ...
        public async Task Init()
        {
            ...
            foreach (var vozilo in list)
            {
                ...
                {
                    //Raèunanje prosjeène ocjene za auto je kodirano u RezervacijaDatumPage.xaml.cs jer
                    //ovaj dio koda ne refreshuje podatke u listi
        ...
        /// </summary>
        public ListaDostupnihVozilaViewModel()
        {
